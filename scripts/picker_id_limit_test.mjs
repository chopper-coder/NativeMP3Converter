...
assert.ok(all.length>=5,"expected File System Access picker ids");
...
assert.deepEqual(sourceIds.sort(),["cmp3-v1-locate-item","cmp3-v1-locate-output","cmp3-v1-output","cmp3-v1-source","cmp3-v1-workspace"].sort());
