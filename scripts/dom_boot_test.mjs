...
const ids=[...new Set(fs.readFileSync(new URL("../index.html",import.meta.url),"utf8").match(/id="([^"]+)"/g)?.map(x=>x.slice(4,-1))||[])];
...
new vm.Script(bundle,{filename:"app.bundle.js"}).runInThisContext();
